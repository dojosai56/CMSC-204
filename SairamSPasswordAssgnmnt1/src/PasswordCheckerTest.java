...
/*
 * import solution.InvalidSequenceException;

import solution.LengthException;
import solution.NoLowerAlphaException;
import solution.NoUpperAlphaException;
import solution.PasswordCheckerUtility;
*/
/**
...
public class PasswordCheckerTest {
	...
	{
		try{
			assertTrue(PasswordCheckerUtility.isValidPassword("5678923aA"));
			PasswordCheckerUtility.isValidPassword("5678923a");
