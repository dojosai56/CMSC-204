...
public class DonationManagerTest {
	static DonationManager manager;
	...
	public void testManagerQueueRecipientSTUDENT() {
		try {
			manager.managerQueueRecipient(new  Recipient("Paula"));
			manager.managerQueueRecipient(new  Recipient("Michael"));
			manager.managerQueueRecipient(new  Recipient("Sean"));
			manager.managerQueueRecipient(new  Recipient("Sayeed"));
			manager.managerQueueRecipient(new  Recipient("Cecilia"));
			manager.managerQueueRecipient(new  Recipient("Sariyya"));
