...
public class ConcordanceDataManager_STUDENT_Test {
	...
	public void testCreateConcordanceFileA() {
		...
		try {
			...
			assertEquals(words.get(0),": 3");
			assertEquals(words.get(1), "all: 3");
			assertEquals(words.get(2),"answer: 1");
			assertEquals(words.get(3),"crazy: 2");
			assertEquals(words.get(4),"daisy: 0");
			assertEquals(words.get(5),"do: 1");
			assertEquals(words.get(6),"for: 3");
			assertEquals(words.get(7),"give: 1");
			assertEquals(words.get(8),"half: 2");
			assertEquals(words.get(9),"i'm: 2");
			assertEquals(words.get(10),"love: 3");
	...
	public void testCreateConcordanceFileB() {
		...
		for(int i=0; i<words.size(); i++)
			...
			assertEquals(": 0, 4, 5, 7, 8, 11, 13", words.get(0));
			assertEquals("am: 9", words.get(1));
			assertEquals("before: 13", words.get(2));
			assertEquals("begin: 6", words.get(3));
			assertEquals("dark: 13", words.get(4));
			assertEquals("have: 3", words.get(9));
			assertEquals("house: 12", words.get(11));
			assertEquals("my: 6", words.get(19));
